...
Asked with the Project 1a product deliberately set aside, because the risk this prompt exists to catch is anchoring. The team's demonstrated output in Project 1a was adversarial testing and evidence discipline, not shipping features — so at least one option that plays to *that* was required.
